...
select mrn, order_date :: Date , lab_time , test_code , test_result_value , unit_of_measurement , reference_range , test_result_value_final, range_low_final, range_hi_final
