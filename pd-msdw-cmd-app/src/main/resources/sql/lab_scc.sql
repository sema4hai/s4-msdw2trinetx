CREATE TABLE hai_az_test.lab_scc_2020July AS
with
	lab_flat as (
		SELECT dp.medical_record_number , f.person_key , f.encounter_key , f.caregiver_group_key , f.facility_key , f.operation_key, dc.calendar_date , f.time_of_day_key,
...
SELECT medical_record_number , encounter_key , facility_key , calendar_date, time_of_day_key,
